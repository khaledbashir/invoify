...
export default function SalesQuotation({ proposal }: Props) {
  ...
  return (
    <div className="bg-neutral-700 min-h-screen py-8 print:bg-white print:py-0">
      ...
      >
        <div className="px-12 pt-10 pb-8 flex-1">
          ...
          <p className="text-[11px] text-neutral-600 leading-relaxed mt-6 mb-8 text-justify">
            ...
            Enterprises, LLC, located at 2 Manhattanville Road, Suite 402, Purchase, NY 10577 ("ANC") (collectively, the
            "Parties") agree that ANC will provide the LED Displays ("Display System") for Stadium, as described below.
          </p>
          ...
          {screens.length === 0 && (
            <div className="text-sm text-neutral-600">No screens configured.</div>
          )}
      ...
      {/* Page 3 - Payment Terms & Agreement */}
      <div
      ...
      >
          ...
          <div className="flex items-center gap-3">
            <div className="text-right text-[10px] leading-tight">
              ...
              <div>
                <span className="text-[#1e3a5f] font-medium">NY</span>{" "}
                <span className="text-neutral-500">914.696.2100</span>{" "}
                <span className="text-amber-600">TX</span>{" "}
                <span className="text-neutral-500">940.464.2320</span>
              </div>
            </div>
            <div className="text-[#1e3a5f] text-2xl font-black tracking-tight" style={{ fontFamily: "Arial Black, sans-serif" }}>
        ...
        <div className="px-12 pb-8 flex-1">
          ...
          <div className="mb-4">
            ...
            <ul className="text-[11px] text-neutral-700 space-y-0.5 ml-4">
              ...
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>C% due upon final acceptance of the work</span>
              </li>
            </ul>
          </div>

          {/* Agreement Text */}
          <div className="text-[11px] text-neutral-700 space-y-3 mb-8">
            ...
            <p className="leading-relaxed">
              If, for any reason, Purchaser terminates this Agreement prior to the completion of the work, ANC will immediately cease all work
          ...
          {/* Agreed and Accepted Section */}
          <h3 className="font-bold text-[11px] text-neutral-800 mb-4 underline">AGREED TO AND ACCEPTED:</h3>

          {/* Signature Section */}
          <div className="grid grid-cols-2 gap-8">
            {/* ANC Signature */}
            <div>
              <p className="text-[10px] font-bold text-neutral-800 mb-0.5">ANC SPORTS ENTERPRISES, LLC ("ANC")</p>
              <p className="text-[10px] text-neutral-600 mb-3">2 Manhattanville Road, Suite 402<br />Purchase, NY 10577</p>

              <div className="space-y-3">
                <div>
                  <p className="text-[10px] text-neutral-700 mb-0.5">By:</p>
                  <div className="border-b border-neutral-400 h-5" />
                </div>
                <div>
                  <p className="text-[10px] text-neutral-700 mb-0.5">Title:</p>
                  <div className="border-b border-neutral-400 h-5" />
                </div>
                <div>
                  <p className="text-[10px] text-neutral-700 mb-0.5">Date:</p>
                  <div className="border-b border-neutral-400 h-5" />
                </div>
              </div>
            </div>
            ...
            {/* Purchaser Signature */}
            <div>
              <p className="text-[10px] font-bold text-neutral-800 mb-0.5">{proposal.clientName} ("PURCHASER")</p>
              <p className="text-[10px] text-neutral-600 mb-3">X</p>
        ...
        <div className="mt-auto">
          <div className="flex justify-between items-center px-12 py-6">
            <div className="text-[11px] text-neutral-500">5</div>
            <div className="flex items-center gap-3">
              <div className="text-right text-[10px] leading-tight">
                <div className="text-neutral-600">www.anc.com/contact</div>
                <div>
              ...
              <div className="text-[#1e3a5f] text-2xl font-black tracking-tight" style={{ fontFamily: "Arial Black, sans-serif" }}>anc</div>
            </div>
          </div>

          {/* Page Divider */}
          <div className="flex justify-center py-4 border-t border-neutral-200 mx-12">
            <div className="w-16 h-1 bg-neutral-300 rounded-full" />
          </div>
        </div>
      </div>
